...
from main import OkavangoData  # We only need to import the Class now!
import pytest
import pandas as pd
...
def test_download_function():
    ...
    test_urls = {"test_forest.csv": "https://ourworldindata.org/grapher/annual-change-forest-area.csv?v=1&csvType=full"}
