"""
Backend data processing module for Project Okavango.

This module contains the core data pipeline. It provides the `OkavangoData` 
class, which is responsible for dynamically downloading environmental datasets 
and geographic shapefiles, validating inputs using Pydantic, and merging the 
most recent country-level metrics onto a global map using Pandas and GeoPandas.
"""
